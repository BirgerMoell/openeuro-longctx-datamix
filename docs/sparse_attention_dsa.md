...
LUMI job `21050508` was the first launch attempt for the next calibration. It failed before
preflight because the shared external Megatron checkout had been removed; no training or output
write occurred. The experiment itself changes the deployed geometry to
