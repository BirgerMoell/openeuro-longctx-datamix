...
**Model:** [`birgermoell/oellm-9b-yarn-multilingual-v2-32k`](https://huggingface.co/birgermoell/oellm-9b-yarn-multilingual-v2-32k) · base LM, no instruction tuning · A100 64GB

| Task | 4K | 8K | 16K | 32K |
|------|-----|-----|------|------|
| niah_single_1 | 1.00 | 1.00 | 1.00 | 0.62 |
| niah_single_2 | 0.66 | 0.35 | 0.02 | 0.02 |
| ruler_fwe | 0.36 | 0.27 | 0.33 | 0.33 |
| **AVG (all 10 tasks)** | **0.43** | **0.28** | **0.20** | **0.11** |

`niah_single_1` = 1.0 up to 16K confirms the YaRN context extension is working. Full results, figures, task descriptions, and next steps: **[docs/ruler_eval_yarn_v2_32k.md](docs/ruler_eval_yarn_v2_32k.md)**
